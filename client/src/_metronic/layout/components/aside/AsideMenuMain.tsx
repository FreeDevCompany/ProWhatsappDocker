...
export function AsideMenuMain() {
  ...
  return (
    <>
      ...
      />
      <AsideMenuItemWithSub to='/settings/' title='Settings' icon='profile-circle'>
        <AsideMenuItem to='/settings/overview' title='Overview' hasBullet={true} />
        <AsideMenuItem to='/settings/settings' title='Settings' hasBullet={true} />
        <AsideMenuItem to='/settings/automation' title='Automation' hasBullet={true} />
